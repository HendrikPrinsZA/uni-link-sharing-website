<?php
	...
	{
		// user chose link...All,friend,cat etc.
...
<head>
	...
	<?php
		//Get the action. Ex: nav from pages
		$action = 0;
...
<body>
	...
	<div id="header-container">
		<header class="wrapper">
			<?php 
				...
				if ($action==50)
					echo "Notification: Link succesfully added!";
				else if ($action==51)
					echo "Notification: Link not added!";
				else if ($action==52)
	...
	<div id="nav">
		...
		<div class="button"><a href="index.php?action=2&linkOption=1">Links</a></div>
	</div>
	<!--end navigation -->
	...
	<div id="main" class="wrapper">
		<div style="position:relative;" id="container" name="container">
			<?php 
				if ($action==0 || $action==99 || $action==98 || ($action>49 && $action<66))
